...
/** @type {string} */
const CACHE_VERSION = '1774655138|2036254911';
/** @type {string} */
const CACHE_PREFIX = 'Protocol: Hex0-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'protocolhex0.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["protocolhex0.html","protocolhex0.js","protocolhex0.offline.html","protocolhex0.icon.png","protocolhex0.apple-touch-icon.png","protocolhex0.audio.worklet.js","protocolhex0.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["protocolhex0.wasm","protocolhex0.pck"];
